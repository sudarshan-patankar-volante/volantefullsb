({
    AssetUpload : function(component, event, helper) {
        var recordId=component.get('v.recordId');
        var url='/sfdcpage/'+encodeURIComponent('/apex/VG_Aesir_Asset_Upload?id=')+recordId+encodeURIComponent('&attType=Assets File&sObjectType=Account');
    ...
    handlePSClick : function(component, event, helper) {
        var rt=$A.get("$Label.c.Aesir_Policy");
        var recordId=component.get('v.recordId');
