({
    handlePSClick : function(component, event, helper) {	
        ...
        //var url='/sfdcpage/'+encodeURIComponent('/apex/VG_Aesir_Step1?id=')+recordId+encodeURIComponent('&Currency=INR&AccountId=0016E00000T6pmT');
        var url='/sfdcpage/'+encodeURIComponent('/apex/VG_Aesir_Step1?id=')+recordId+encodeURIComponent('&Currency=')+CC;
    ...
    gotoBasePolicy : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if(state=="SUCCESS" && basePolicyId != null){
                window.open('/Aesir/s/policy/'+basePolicyId,'_blank');
    ...
    checkPolicyAssets : function(component, event, helper) {
        var recordId=component.get('v.recordId');
        window.open('/Aesir/s/sfdcpage/'+encodeURIComponent('/apex/VG_Show_Policy_Assets?id=')+recordId,'_blank','height=500px,top=200px,width=700px;');
    },
