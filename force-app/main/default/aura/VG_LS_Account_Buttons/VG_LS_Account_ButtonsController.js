({
    handleClick : function(component, event, helper) {
        ...
        var url='/sfdcpage/'+encodeURIComponent('/apex/VG_LSAssetsUpload?id=')+recordId+encodeURIComponent('&attType=Assets File&sObjectType=Account');
    ...
    handlePSClick : function(component, event, helper) {
        var rt=$A.get("$Label.c.Affinity_Policy");
        var recordId=component.get('v.recordId');
